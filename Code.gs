...
function getLocalNCO1828Reply(msg) {
  ...
  if (q.includes("ไม่ใช่") || q.includes("ไม่ได้เป็น") || q.includes("คนนอก") || q.includes("ญาติ") || q.includes("ผู้ติดตาม")) {
    return "✨ สามารถเข้าร่วมงานได้ครับ!\nสำหรับผู้ที่ไม่ได้เป็นสมาชิก NCO.1828 สามารถลงทะเบียนเข้าร่วมงานได้เช่นกันครับ:\n• 1 ท่าน: 1,500 บาท\n• 2 ท่าน: 2,000 บาท\n👉 ในแบบฟอร์มลงทะเบียน สามารถเลือกประเภทสมาชิกเป็น 'ผู้ไม่ได้เป็นสมาชิก' เพื่อร่วมงานได้เลยครับ!";
  }
